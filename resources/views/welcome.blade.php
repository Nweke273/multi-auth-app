    ...
    <div
        ...
        <div class="hidden fixed top-0 px-6 py-4 sm:block">
            <div class="container">
                ...
                <a href="{{ route('admin.login') }}" class="text-sm text-gray-700 underline"
                    style="margin-left: 10px">Admin Login</a>

                @if (Route::has('user.register'))
                <a href="{{ route('user.register') }}" class="ml-4 text-sm text-gray-700 underline">Register User</a>
                <a href="{{ route('admin.register') }}" class="ml-4 text-sm text-gray-700 underline"
                    style="margin-left: 10px">Register Admin</a>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <h1>Multi Authentication Web Application</h1>
        </div>
    </div>
</body>
